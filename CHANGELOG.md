...
v1.7.3은 CTD 2건과 어픽스 발동이 영구히 멈추는 결함 1건을 수정하는 안정성 릴리스입니다. v1.7.2는 태그되지 않았으므로 이 릴리스에는 v1.7.1 이후의 모든 변경이 포함됩니다.
...
- 위 수정 3건은 정적 분석과 회귀 테스트로 검증했으며, 실제 크래시 재현 부재는 인게임 확인이 필요합니다.
