...
- 룬워드 패널에서 **재련 오브(Reforge Orb)** 를 사용해 선택 장비 어픽스를 재련할 수 있습니다.
...
기본값: `loot.chancePercent=25`, `loot.runewordFragmentChancePercent=40`, `loot.renameItem=true`, `loot.nameMarkerPosition=trailing`, `loot.sharedPool=true` (무기/방어구 공용 풀 롤링)
...
- 재련 오브(리포지):
  ...
  - 어픽스가 없는 장비도 재련할 수 있으며, 이 경우 1줄 목표 롤을 시도합니다.
