...
namespace CalamityAffixes
{
		...
		SyntheticRunewordStyle a_style)
	{
		...
		static constexpr std::array kRecipeTunings = {
			...
			RecipeTuning{ "rw_spirit", 28.0f, 10.0f, kUnsetValue, kUnsetValue },
			...
			RecipeTuning{ "rw_fury", 24.0f, 12.0f, kUnsetValue, kUnsetValue },
