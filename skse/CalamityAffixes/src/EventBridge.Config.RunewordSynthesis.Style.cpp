...
namespace CalamityAffixes
{
		...
		SyntheticRunewordStyle a_style)
	{
		...
		static constexpr std::array kRecipeTunings = {
			...
			RecipeTuning{ "rw_rift", 8.0f, 18.0f, kUnsetValue, kUnsetValue },
			...
			RecipeTuning{ "rw_wind", 22.0f, 4.0f, kUnsetValue, kUnsetValue },
			...
			RecipeTuning{ "rw_passion", 26.0f, 7.0f, kUnsetValue, kUnsetValue },
			RecipeTuning{ "rw_harmony", 21.0f, 3.8f, kUnsetValue, kUnsetValue },
			RecipeTuning{ "rw_memory", 20.0f, 9.0f, kUnsetValue, kUnsetValue },
			RecipeTuning{ "rw_temper", 18.0f, 8.0f, kUnsetValue, kUnsetValue },
			...
			RecipeTuning{ "rw_melody", 22.0f, 8.0f, kUnsetValue, kUnsetValue },
			...
			RecipeTuning{ "rw_duress", 24.0f, 10.0f, kUnsetValue, kUnsetValue },
			RecipeTuning{ "rw_stone", 24.0f, 11.0f, kUnsetValue, kUnsetValue },
			...
			RecipeTuning{ "rw_wisdom", 18.0f, 11.0f, kUnsetValue, kUnsetValue },
